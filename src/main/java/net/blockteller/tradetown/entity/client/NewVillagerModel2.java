...
public class NewVillagerModel2<T extends Entity> extends HierarchicalModel<T> {
    private final ModelPart rhino;
    private final ModelPart head;

    public NewVillagerModel2(ModelPart root) {
...
public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
	...
	headwear2.render(poseStack, vertexConsumer, packedLight, packedOverlay);
	nose.render(poseStack, vertexConsumer, packedLight, packedOverlay);
	body.render(poseStack, vertexConsumer, packedLight, packedOverlay);
	bodywear.render(poseStack, vertexConsumer, packedLight, packedOverlay);
